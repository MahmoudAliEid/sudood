...
export function AIFuturePageClient({ lang: initialLang }: { lang: Language }) {
  ...
  const content = {
    ...
    ar: {
      ...
      subtitle: "نظام التحكم عن بعد والحماية من التسرب المدعوم بالذكاء الاصطناعي",
      description: "يجمع هذا الصمام الكروي الذكي بين الموثوقية الميكانيكية والتحكم الرقمي الذكي، مما يتيح المراقبة في الوقت الفعلي والتشغيل عن بعد من خلال تطبيق الهاتف المحمول.",
      aiTitle: "ذكاء متكامل بالذكاء الاصطناعي",
      aiLogic: "مدعوماً بمنطق الذكاء الاصطناعي، يمكن للنظام اكتشاف أنماط تدفق المياه غير الطبيعية، أو التسربات المحتملة، أو سلوك الاستخدام غير المتوقع، ويقوم تلقائياً بإغلاق الصمام لمنع التلف لايقاف هدر الماء و التسريب و التلفيات.",
      stats: {
      ...
      apps: [
        { icon: Home, title: "سكني", desc: "المنازل الذكية والمباني السكنية الحديثة" },
        { icon: Building2, title: "تجاري", desc: "المكاتب والمرافق والمنشآت التجارية" },
        { icon: Factory, title: "حماية عامة", desc: "خطوط الإمداد الرئيسية والمطابخ والحمامات" },
      ],
