...
export function AIFuturePageClient({ lang: initialLang }: { lang: Language }) {
  ...
  const content = {
    ...
    ar: {
      ...
      aiLogic: "مدعوماً بمنطق الذكاء الاصطناعي، يمكن للنظام اكتشاف أنماط تدفق المياه غير الطبيعية، أو التسربات المحتملة، أو سلوك الاستخدام غير المتوقع، ويقوم تلقائياً بإغلاق الصمام لمنع التلف.",
      stats: {
