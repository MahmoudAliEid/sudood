...
export const translations = {
  ...
  ar: {
    ...
    // Home
    home: {
      title: 'سدود — محابس وصمامات مياه وغاز بجودة عالية',
    ...
    about: {
      title: 'عن سدود',
      description: 'سودود شركة سعودية تركز على توريد وتصنيع محابس وصمامات مياه وغاز من مواد عالية النقاء (نحاس برونز) وتصاميم تتحمل الملوحة والمياه العسرة. جميع العمليات تحت إشراف فريق هندسي سعودي مع شهادات جودة عالمية.',
      mission: 'مهمتنا',
      missionDesc: 'تقديم محابس وصمامات بجودة عالمية تحقق أعلى المعايير الدولية مع دعم النمو الإقليمي للبنية التحتية والقطاع الصناعي.',
      vision: 'رؤيتنا',
      visionDesc: 'أن نكون الشريك المفضل لحلول محابس وصمامات المياه والغاز في منطقة الخليج.',
    },
    // Services
    services: {
      title: 'خدماتنا',
      service1: 'التصنيع والتجميع المخصص',
      service1Desc: 'تصنيع وتجميع محابس وصمامات وفق مواصفات المشروع.',
      service2: 'التوريد للمقاولين والمتاجر',
      service2Desc: 'توريد لمقاولين ومتاجر السباكة والمشاريع العامة والصناعية.',
      service3: 'الدعم الفني والتكامل الذكي',
      service3Desc: 'دعم تقني وتركيب للمنتجات الذكية والتكاملات المتقدمة.',
      service4: 'الاختبار والشهادات',
      service4Desc: 'اختبارات وفحص جودة ومطابقة شهادات دولية.',
    },
    // Products
    products: {
      title: 'منتجاتنا',
      subtitle: 'تشكيلة واسعة من المحابس والصمامات عالية الجودة المصممة لتدوم',
      filterAll: 'الكل',
